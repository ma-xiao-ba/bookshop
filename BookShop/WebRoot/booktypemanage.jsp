						...
						<div class="container-fluid">
							...
							<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav menu__list">
									<li class="active menu__item menu__item--current"><a class="menu__link" href="admin.html">图书管理<span class="sr-only">(current)</span></a></li>
									<li class=" menu__item"><a class="menu__link" href="queryBookTypes.action">分类管理</a></li>
									<li class="dropdown menu__item"> 
										<a href="queryOrder.action"   class="dropdown-toggle menu__link"  role="button"  aria-haspopup="true"
			...
			<div class="container">
				<div class="sap_tabs">
					<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						<table id="typemanage" class="table table-striped table-hover table-bordered">
							<thead>
								<tr>
									<th>分类名称</th>
									<th>操作</th>
							...
							<tbody>
							 <c:forEach items="${bts}" var="booktype">
								<tr>
									<td>${booktype.btname}</td>
									<td><a href=modifyBookType.action?btid=${booktype.btid} type="button">修改</a></td>
								</tr>
							</c:forEach>
							</tbody>
						</table>
