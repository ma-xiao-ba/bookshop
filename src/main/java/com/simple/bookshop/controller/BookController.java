...
public class BookController {
    ...
    public String queryHottestBooks(HttpServletRequest session) {
    ...
    public String addbook(HttpServletRequest request, Book book) throws IllegalStateException, IOException {
        ...
        String localPath1 = "D:\\Java_project\\eclipse\\BookStore\\WebRoot\\images\\book\\";
        ...
        sqlPath = "src/webFiles/images/book/" + filename;
